...
const SalesRegister = () => {
    ...
    const { data, isLoading, isFetching } = useGetSalesBillQuery({ params });
                                        ...
                                        <Fragment key={index}>
                                            ...
                                            {(currentOpenNumber === index)
                                                ...
                                                <table class=" border text-xs  w-screen mt-1">
                                                    ...
                                                    <tbody className='bg-yellow-200 mt-2 '>
                                                        {singleData?.data?.SalesBillItems.map((poItem, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td className='py-1 text-right border-2 border-gray-400'>{poItem.stockQty}</td>
                                                                <td className='py-1 text-right border-2 border-gray-400'>{parseFloat(poItem?.price).toFixed(2)}</td>
